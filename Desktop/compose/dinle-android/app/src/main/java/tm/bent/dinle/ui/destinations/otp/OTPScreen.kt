...
fun  OTPScreen(
    ...
    var (isError, setIsError) = remember {
        mutableStateOf(false)
    }
    ...
    LaunchedEffect(uiState.failure){
        if (uiState.failure){
            ...
            Log.i("otp2", "OTPScreen: "+ isError)
        }

    }
    Log.i("otp", "OTPScreen: "+isError)
        ...
        Column(
            ...
            BasicTextField(
                ...
                onValueChange = {
                    ...
                    onCodeChange(it)
                    if (it.length == 4) verificationViewModel.verify(phone, it.toInt())
            ...
            Text(
                modifier = Modifier.clickWithoutIndication {
                    verificationViewModel.loginUser(phone)
                },
